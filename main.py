...
Two-Way Knapsack with BB84 Protocol
Cryptography Assignment 

Note: Combined all the files into one file for easier access. 
"""
...
# Eve's in a Perfect World
system = TwoWayKnapsackWithBB84(bit_length=32, toggle_eve=True)
